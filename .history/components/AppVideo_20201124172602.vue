...
import Fullscreen from '@/assets/svg/fullscreen.svg?inline'
...
.thumbnail-enter-active
  transition opacity .8s easeInCubic

.thumbnail-leave-active
  transition opacity .8s easeOutCubic
...
.play-enter-active
  transition opacity .5s linear, transform .5s easeOutCubic
